...
class Suit(Clothes):
    ...
    @property
    def get_expenses(self):
        return int(2 * self.size + 0.3)


coat = Coat(48)
suit = Suit(52)
print(coat.get_expenses)
print(suit.get_expenses)
print(f'Total expenses are {coat.get_expenses + suit.get_expenses}')
